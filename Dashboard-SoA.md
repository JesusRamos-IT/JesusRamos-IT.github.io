...
| **A.6 Controles de Personas** | 8 | Ciclo de vida del personal (antes, durante y tras el cese), acuerdos de confidencialidad, directrices de teletrabajo y planes de concienciación. | 🟢 Operativo | [Módulo 6](./02-Criterios-Anexo-A/6-Controles-Personas/index.md) |
| **A.7 Controles Físicos** | 14 | Perímetros de seguridad, barreras físicas, protección contra amenazas ambientales, seguridad en oficinas, instalaciones y soportes de almacenamiento. | 🟢 Operativo | [Módulo 7](./02-Criterios-Anexo-A/7-Controles-Fisicos/index.md) |
| **A.8 Controles Tecnológicos** | 34 | Autenticación, gestión de privilegios, cifrado, copias de seguridad, monitorización de sistemas, gestión de vulnerabilidades y desarrollo seguro. | 🟢 Operativo | [Módulo 8](./02-Criterios-Anexo-A/8-Controles-Tecnologicos/index.md) |
